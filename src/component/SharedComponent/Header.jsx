const Header =(props)=>{
    ...
    <div className="container-fluid mx-auto  sm:block lg:hidden bg-no-repeat bg-cover " style={{backgroundImage:`url('/assets/img/monas2.jpg')`,height:"500px",width:"100%"}}>
        <div className=" grid grid-cols-1 gap-4 content-center" style={{height:"500px"}}>
                <div className="sm:mt-0 ml-16">
                        <div className="ml-6">
                            <img src="https://pojokan.io/img/logo.webp" className="h-10" alt="logo" />
                            <div className="text-white mt-5" >
